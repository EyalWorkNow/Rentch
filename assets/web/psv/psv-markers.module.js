  ...
  update(config) {
    ...
    if (utils6.isExtendedPosition(this.config.position)) {
      ...
      if (this.config.orientation) {
        utils6.logWarn(`Marker#orientation is deprecated, use "rotation.yaw" or "rotation.pitch" instead`);
...
import { PSVError as PSVError7, utils as utils8 } from "@photo-sphere-viewer/core";
